...
pub fn last_state_output_string() -> String {
    let hex = match std::env::var("RELAYER_START_STATE") {
        Ok(hex_string) => hex_string,
        Err(_) => "".to_string(),
    };
    hex.to_string()
}
